      ...
      <section name="profilePage" id="profile">
        <div id="profilePicInfo">
          ...
          <div id="userInfo">
            ...
            $followers = getFollowersNumber(getUserID($username));
            $following = getFollowingNumber(getUserID($username));
            ...
            <form action="" method="post" id="deleteUser">
              <input type="hidden" name="username1" value="<?php echo  $userInfo["username"] ?>" required/> 
