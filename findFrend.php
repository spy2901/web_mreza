            ...
            <div id="profilePicInfo">
                ...
                <div id="userInfo">
                    ...
                    <form action="" method="post" id="user">
                        ...
                        <?php $followers = getFollowersNumber(getUserID($sent_username));
                        $following = getFollowingNumber(getUserID($sent_username)); ?>
                        <div class="input-group">
                            <label>Followers</label>
                            <h2><b><?php echo $followers ?></b></h2>
                        </div>
                        <div class="input-group">
                            <label>Following</label>
                            <h2><b><?php echo $following ?></b></h2>
                        </div>
